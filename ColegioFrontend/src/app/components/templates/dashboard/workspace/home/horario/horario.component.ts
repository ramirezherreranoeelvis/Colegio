...
export class HorarioComponent {
      ...
      public updateDataStudentSelect(): void {
            ...
            studentSelect = this.students.find(
                  (s) => s.dni == this.studentSelectDNI,
            );
            this.temporadaService
                  .findAllSeasonByStudent(studentSelect.dni)
                  .subscribe((t: Temporada[]) => {
                        this.temporadas = t;
                  });
      }
      ...
      public updateHorario(): void {
            ...
            var temporada: Temporada = this.temporadas.find(
                  (t) => t.year.toString() == this.idTemporadaSelect,
            );
            this.horarioService
                  .obtenerHorarioPorTemporada(
                        temporada.year,
